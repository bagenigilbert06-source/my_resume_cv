  ...
  return (
    <section className="section" id="education"><div className="container two-column">
      ...
      <div className="timeline">
        ...
        <article><span className="timeline-dot" /><time>Continuous</time><h3>Self-Taught Technology Enthusiast</h3><p>Independent Learning</p><p>Continuously exploring new technologies, building personal projects, and strengthening my skills through documentation, experimentation, and community resources.</p></article>
        <article><span className="timeline-dot" /><time>2017 — 2021</time><h3>High School Diploma</h3><p>Matare Boys High School</p><p>Built a strong academic foundation and developed a lasting curiosity for technology and problem-solving.</p></article>
      </div>
    </div></section>
  );
}
